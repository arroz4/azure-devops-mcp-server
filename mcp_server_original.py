...
However, when creating work items, it MUST provide COMPREHENSIVE and DETAILED task descriptions following the proven structure from Work Item ID 89, including all required sections: Objective, Technical Requirements, Implementation Steps, Acceptance Criteria, and Business Context.
...
**⚠️ IMPORTANT**: Always create COMPREHENSIVE and DETAILED task descriptions following the proven structure from Work Item ID 89, including all required sections: Objective, Technical Requirements, Implementation Steps, Acceptance Criteria, and Business Context.
...
**📋 Task Description Requirements (MANDATORY STANDARD):**
Task descriptions MUST be **COMPREHENSIVE and DETAILED** following the proven structure from Task ID 89. This is the REQUIRED standard for all tasks. Include ALL of these sections:

**REQUIRED SECTIONS:**
- **## Objective**: Clear statement of what needs to be accomplished and contribution to parent Epic
- **## Technical Requirements**: Specific tools, permissions, technical constraints, and integration points
- **## Implementation Steps**: Detailed numbered breakdown (8-10 steps minimum) of all work to be performed
- **## Acceptance Criteria**: Specific, testable conditions using checkboxes (6-8 criteria minimum)
- **## Business Context**: Clear explanation of business value and enterprise architecture alignment

**QUALITY STANDARDS:**
- Minimum 4-5 sentences per section for comprehensive coverage
- Use proper HTML formatting with headers (##), lists, and checkboxes
- Include specific technology stack references (Azure Synapse, ADLS Gen2, Power BI, etc.)
- Ensure production-ready specifications with measurable outcomes
- Reference Work Item ID 89 as the gold standard example
...
1. **Plan your Epic and Tasks**
   ...
   - **IMPORTANT**: Task descriptions MUST be COMPREHENSIVE and DETAILED following the proven structure from Work Item ID 89. Each description must include all required sections: Objective, Technical Requirements, Implementation Steps, Acceptance Criteria, and Business Context with proper formatting (8-10 implementation steps minimum, 6-8 acceptance criteria minimum).
...
@mcp.resource("ado://standard/gold")
def gold_standard():
    """Work Item ID 89 Gold Standard - Reference template for all work items"""
    return {
        "uri": "ado://standard/gold",
        "name": "Work Item ID 89 - Gold Standard Reference",
        "description": "Comprehensive structure and quality standard based on Work Item ID 89 for both Epics and Tasks",
        "mimeType": "text/markdown",
        "text": """# 🏆 Work Item ID 89 - Gold Standard Reference

**ORIGINAL WORK ITEM**: ID 89 "Data Import and Validation" from Epic 81 "Automation Semantic Model"

This work item established the definitive quality standard for all Azure DevOps work items. Every Epic and Task MUST match or exceed this comprehensive structure and detail level.

## 📋 Gold Standard Structure (5 Mandatory Sections)

### ## Objective
**Purpose**: Clear statement of what needs to be accomplished and contribution to business goals or parent Epic.

**Quality Requirements**:
- Minimum 2-5 sentences explaining purpose, scope, and expected outcome
- Clear business value proposition and strategic alignment
- Specific contribution to parent Epic (for Tasks) or organizational goals (for Epics)
- Technical context and integration with existing systems

**Example from ID 89**:
```
Implement comprehensive data import and validation system for the semantic model to ensure data integrity and quality throughout the TOML architecture implementation. This task establishes the data ingestion pipeline that validates, cleanses, and transforms raw data from multiple sources into the structured format required by the semantic model. The system will include automated data quality checks, error handling, and monitoring capabilities to maintain high data standards. This work directly enables reliable analytics and reporting by ensuring only validated, high-quality data enters the semantic model.
```

### ## Technical Requirements
**Purpose**: Specific technical constraints, tools, permissions, technology stack, and integration points.

**Quality Requirements**:
- Minimum 2-5 specific technical requirements
- Include specific Azure services (Synapse, ADLS Gen2, Power BI, etc.)
- Security requirements and compliance considerations
- Performance standards and technical constraints
- Integration points with existing systems

**Example from ID 89**:
```
- Azure Synapse Analytics integration with optimized SQL query performance
- ADLS Gen2 storage connectivity for scalable data lake operations
- Data validation framework supporting business rules and technical constraints
- Error handling and logging system for comprehensive audit trails
- Automated data quality monitoring with alerting capabilities
- Integration with existing ETL processes and data governance policies
- Support for multiple data formats including CSV, JSON, and Parquet files
```

### ## Implementation Steps
**Purpose**: Detailed numbered breakdown of all work to be performed.

**Quality Requirements**:
- MINIMUM 2-5 steps with specific actions and technical details
- Each step should be actionable and measurable
- Include validation approaches and quality checkpoints
- Progressive complexity from analysis to deployment
- Technical specifications and configuration details

**Example from ID 89**:
```
1. Analyze existing data sources and document data schemas, formats, and quality characteristics
2. Design data validation rules framework covering completeness, accuracy, and consistency checks
3. Implement Azure Synapse stored procedures for data extraction and transformation logic
4. Create ADLS Gen2 folder structure with proper security and access controls
5. Develop automated data quality validation scripts with comprehensive error reporting
6. Build monitoring dashboard for data pipeline health and performance metrics
7. Implement error handling procedures with automated retry logic and failure notifications
8. Configure data lineage tracking to maintain audit trails and impact analysis
9. Establish automated testing framework for validation logic and data transformation accuracy
10. Deploy production pipeline with comprehensive monitoring and alerting capabilities
```

### ## Acceptance Criteria
**Purpose**: Specific, testable conditions using checkboxes that define completion.

**Quality Requirements**:
- MINIMUM 6-8 criteria that are measurable and verifiable
- Cover functional, technical, and quality aspects
- Use checkbox format: - [ ] criterion
- Include performance benchmarks and success metrics
- Address security, compliance, and operational requirements

**Example from ID 89**:
```
- [ ] Data import pipeline successfully processes all identified source systems with 100% accuracy
- [ ] Validation rules framework identifies and flags data quality issues with detailed reporting
- [ ] Error handling system captures and logs all exceptions with appropriate recovery actions
- [ ] Performance benchmarks achieved with data processing completing within defined SLA timeframes
- [ ] Monitoring dashboard operational with real-time status updates and historical trend analysis
- [ ] Automated testing suite validates all transformation logic with 95% code coverage
- [ ] Production deployment completed with zero data loss and validated business continuity
- [ ] Documentation completed including technical specifications, operational procedures, and troubleshooting guides
```

### ## Business Context
**Purpose**: Clear explanation of business value, enterprise architecture alignment, and organizational impact.

**Quality Requirements**:
- Minimum 2-5 sentences explaining business value and strategic importance
- Connection to organizational goals and competitive advantage
- Impact on automation initiatives and data solutions
- Stakeholder benefits and revenue implications
- Enterprise architecture alignment and scalability considerations

**Example from ID 89**:
```
This data import and validation system ensures the semantic model maintains the highest standards of data quality, directly supporting Omar's Solutions' reputation for delivering reliable data solutions to clients. The automated validation and monitoring capabilities reduce operational overhead while providing confidence in data accuracy for critical business decisions. This system enables scalable data operations that support business growth and provides the foundation for advanced analytics and automation initiatives. The comprehensive error handling and monitoring capabilities ensure business continuity and minimize the risk of data-related business disruptions.
```

## 🎯 Quality Standards Summary

### Content Quality Benchmarks:
- **Comprehensive Detail**: Each section contains substantial, actionable information
- **Technical Specificity**: Includes specific Azure services, tools, and constraints
- **Measurable Outcomes**: All criteria are testable and verifiable
- **Business Alignment**: Clear connection to organizational goals and value
- **Production Ready**: Specifications detailed enough for immediate implementation

### Formatting Standards:
- Use proper HTML formatting with headers (##) for Azure DevOps rendering
- Include bullet points (-) and checkboxes (- [ ]) for structured lists
- Use \\n for line breaks in description fields for proper paragraph formatting
- Maintain consistent structure across all work items

### Reference Usage:
- **For Epics**: Adapt the structure to describe large-scale initiatives and features
- **For Tasks**: Use the exact structure as demonstrated in Work Item ID 89
- **Quality Check**: Every work item must match or exceed ID 89's detail level
- **Continuous Reference**: Use this standard for all future work item creation

## 🏅 Why Work Item ID 89 is the Gold Standard

### Proven Excellence:
- **Comprehensive Scope**: Covers all aspects from technical requirements to business value
- **Production Ready**: Provides complete specifications for immediate implementation
- **Measurable Success**: Includes specific, testable acceptance criteria
- **Strategic Alignment**: Clearly connects technical work to business objectives
- **Operational Excellence**: Addresses monitoring, error handling, and business continuity

### Organizational Impact:
- Sets the benchmark for all Azure DevOps work items within Omar's Solutions
- Ensures consistent quality across all project documentation
- Provides template for scalable project management practices
- Establishes enterprise-grade specifications for client work
- Supports reputation for delivering reliable, comprehensive data solutions

---

**Remember**: Work Item ID 89 represents the quality standard that drives organizational excellence. Every work item should aspire to match or exceed this benchmark! 🎯
"""
    }

@mcp.resource("ado://template/description")
def description_template():
    """Quick reference template for creating work item descriptions - references Gold Standard for full details"""
    return {
        "uri": "ado://template/description",
        "name": "Work Item Description Template - Quick Reference",
        "description": "Concise template with structure and examples - see Gold Standard resource for complete requirements",
        "mimeType": "text/markdown",
        "text": """# 📝 Work Item Description Template - Quick Reference

**🏆 REFERENCE**: See the **Gold Standard resource** (`ado://standard/gold`) for complete structure details, quality requirements, and the original Work Item ID 89 examples.

## 🚀 Quick Template Structure

```
## Objective
[4-5 sentences: What needs to be accomplished and business contribution]

## Technical Requirements
[4-6 specific requirements: Azure services, tools, constraints, integrations]
- Azure Synapse Analytics integration
- ADLS Gen2 storage connectivity  
- [Additional technical specifications]

## Implementation Steps
[8-10 numbered steps: Detailed breakdown with technical actions]
...
## Acceptance Criteria
[6-8 testable conditions with checkboxes]
- [ ] [Functional requirement with success metric]
- [ ] [Performance benchmark with specific target]
- [ ] [Quality assurance with measurable outcome]
- [ ] [Documentation and deployment completion]
[Additional criteria as needed]

## Business Context
[4-5 sentences: Business value, enterprise alignment, organizational impact]
```

## 💡 Key Reminders

### Quality Standards:
- **Match Gold Standard**: Every work item must meet or exceed the quality level established in the Gold Standard resource
- **Be Comprehensive**: Include substantial detail in each section - avoid brief or vague descriptions
- **Think Production**: Write specifications detailed enough for immediate implementation
- **Technical Specificity**: Include specific Azure services, performance metrics, and technical constraints

### Formatting:
- Use `\\n` for line breaks in description fields
- Use proper headers (`##`) for section organization
- Include checkboxes (`- [ ]`) for acceptance criteria
- Reference specific technologies (Azure Synapse, ADLS Gen2, Power BI)

### Common Mistakes to Avoid:
- ❌ Brief, vague descriptions lacking detail
- ❌ Missing any of the 5 mandatory sections
- ❌ Acceptance criteria without measurable outcomes
- ❌ Technical requirements without specific tools/services
- ❌ Implementation steps that are too high-level

### Success Formula:
1. **Review Gold Standard** for structure and quality requirements
2. **Copy template structure** above as your starting point
3. **Fill each section comprehensively** with specific, actionable content
4. **Validate against Gold Standard** to ensure quality matches the benchmark
5. **Include specific Azure services** and technical details throughout

---

**Remember**: The Gold Standard resource contains the complete reference - use it for detailed examples and quality benchmarks! 🎯
"""
    }
...
def create_work_item(
    ...
    Args:
        work_item_type: The type of work item to create ("Task" or "Epic")
        title: The title of the work item
        description: Description of the work item. For Tasks, follow Work Item ID 89 comprehensive structure with all required sections: Objective, Technical Requirements, Implementation Steps, Acceptance Criteria, and Business Context (supports Markdown formatting - MUST use \\n for line breaks which converts to paragraph breaks)
        assigned_to: Email address of the person to assign
        priority: Priority level (1-4, where 1 is highest)
        tags: Semicolon-separated tags
...
def update_work_item(
    ...
    Args:
        ...
        description: New description for Tasks should follow Work Item ID 89 comprehensive structure with Objective, Technical Requirements, Implementation Steps, Acceptance Criteria, and Business Context sections (supports HTML formatting - MUST use \\n for line breaks which converts to HTML paragraphs)
...
def create_epic_with_tasks(
    ...
    """
    Creates an Epic with multiple Tasks and links them together, then provides
    a comprehensive summary with URLs.
    
    This is the RECOMMENDED workflow for creating Epics with multiple tasks
    in a single operation. The function automatically creates all work items,
    establishes parent-child relationships, and provides a detailed breakdown
    table with URLs for immediate access to all created items.
    
    KEY FEATURE - Enhanced User Experience:
    When printing work items in chat, ALWAYS displays both ID and direct
    Azure DevOps URL for each item. This enables immediate click-through
    access to any work item without manual navigation. The summary table
    includes clickable URLs for the Epic and all child Tasks for optimal
    workflow.
    ...
    Args:
        ...
        task_descriptions: Descriptions for each task, separated by |||
            delimiter to avoid conflicts with commas in content. Each
            description MUST follow the proven structure from Work Item ID 89.
            Include ALL required sections: ## Objective (clear accomplishment
            statement), ## Technical Requirements (specific tools/constraints),
            ## Implementation Steps (8-10 numbered steps minimum),
            ## Acceptance Criteria (6-8 testable checkboxes), ## Business
            Context (enterprise value explanation). Minimum 4-5 sentences per
            section with proper formatting. Reference ID 89 as the gold
            standard. Use ||| to separate multiple descriptions (e.g.,
            "Description 1 ||| Description 2 ||| Description 3"). Legacy
            comma separation supported only when count matches task count.
            (optional, must match task_titles count if provided - MUST use
            \\n for line breaks which converts to HTML paragraphs)
    ...
    Returns:
        Comprehensive summary table with Epic and Task IDs, URLs, linking
        status, and next steps. This breakdown provides immediate access to
        all created work items with their direct Azure DevOps URLs for
        optimal user experience and workflow efficiency.
    """
    try:
        ...
        # Use ||| as delimiter to avoid comma conflicts
        desc_list = []
        if task_descriptions.strip():
            ...
            if "|||" in task_descriptions:
                ...
                if len(comma_split) == len(task_list):
